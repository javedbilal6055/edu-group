...
const UISchema = {
  ...
  "institutionTitle": {
      ...
      "ui:widget": () => {
          return (
              <h2 className="institution-register__title">A request has been submitted Successfully </h2>
          )
      }
  },
  "titleDescription": {
      ...
      "ui:widget": () => {
          return (
              <h2 className="institution-register__description">Please choose a password to Create Profile, By Creating profile you will be able to get all updates easily </h2>
          )
      }
  },
  "instituteUserPassword": {
  ...
  "instituteConfirmPassword": {
      ...
      "classNames": "step-2 institution-register__confirm-password-input hidden-element"
  },
}
