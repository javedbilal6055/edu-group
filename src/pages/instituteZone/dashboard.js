...
import InstituteSidebar from '../../InstituteZone/sidebar/sidebar.js';
import InstituteNavbar from '../../InstituteZone/navbar/navbar';
...
const InstituteDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (userDataRedux === null) {
            ...
            history.push("/home");
        }else if(userDataRedux.role != 'institute')
        {
            console.log('Not an Institutional user');
            history.push("/home");
        ...
        return (
            ...
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <InstituteNavbar  name={userDataRedux != null ? userDataRedux.firstName : ''} />
                        ...
                        <div class="row g-3 my-2">
                            ...
                            <div class="col-md-3">
                                <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                    ...
                                    <i
                                        class="fa fa-hand-holding-usd fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                                </div>
                            </div>
