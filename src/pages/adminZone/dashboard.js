...
import AdminSidebar from '../../AdminZone/sidebar/sidebar.js';
import AdminNavbar from '../../AdminZone/navbar/navbar';
const AdminDashboard = () => {
    ...
    useEffect(() => {
        ...
        if (userDataRedux === null) {
            ...
            history.push("/home");
        }else if(userDataRedux.role != 'admin')
        {
        ...
        return (
            <div class="d-flex" id="wrapper">
                ...
                <div id="page-content-wrapper">
                    ...
                    <AdminNavbar  name={userDataRedux != null ? userDataRedux.firstName : ''} />
