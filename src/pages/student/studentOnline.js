...
const StudentOnline = () => {
    ...
    window.addEventListener('click', (e) => {
        if (e.target.classList.contains('custom-button__otp-button')) {
            ...
            if (thisForm != undefined && !thisForm.classList.contains('otp-sent')) {
                ...
                let otpField = thisForm.querySelector('.studentOnline-register__otp-box .form-control');
    ...
    return (
        <div className={`${multiStepFormRedux.status === "step-1-completed" && 'step-2-design'} student-online-wrapper`}>

            <HeroBannerForm imageName="imgStuOn" formType="studentOnline-register" buttonText={"Schedule Demo"} buttonStyleName={"herobutton"} {...buttonSwitchData} {...buttonGridData} />
